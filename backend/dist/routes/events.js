...
// --- ヘルパー関数: 私的補講の取得 ---
const getSupplementaryLectures = async (startDate, endDate) => {
...
// --- ヘルパー関数: 個人予定の取得 ---
const getPersonalEvents = async (userId, startDate, endDate) => {
...
// --- ヘルパー関数: 大学公式の講義の動的生成 ---
const getOfficialLectures = async (startDate, endDate) => {
